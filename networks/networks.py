...
class MultiHeadCriticNetwork_noise(nn.Module):
    ...
    def forward(self, state, action):
        ...
        features2 = F.relu(self._h2(features1))
        if self.training:
            q0 = self.head0(features2 + torch.randn_like(features2)*0.01)
            q1 = self.head1(features2 + torch.randn_like(features2)*0.01)
            q2 = self.head2(features2 + torch.randn_like(features2)*0.01)
            q3 = self.head3(features2 + torch.randn_like(features2)*0.01)
            q4 = self.head4(features2 + torch.randn_like(features2)*0.01)
            q5 = self.head5(features2 + torch.randn_like(features2)*0.01)
            q6 = self.head6(features2 + torch.randn_like(features2)*0.01)
            q7 = self.head7(features2 + torch.randn_like(features2)*0.01)
            q8 = self.head8(features2 + torch.randn_like(features2)*0.01)
            q9 = self.head9(features2 + torch.randn_like(features2)*0.01)
        else:
